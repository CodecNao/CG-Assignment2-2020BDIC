...
public class MainWindow {
	...
	public void renderGL() {
		...
		// here is my method to draw Tetrahedron
		...
		GL11.glRotatef(45, 0f, 1f, 0f);
		GL11.glRotatef(rotation, 1f, 1f, -1f); 
		// here is my method to draw Cube
		...
		GL11.glRotatef(rotation, 1f, 1f, -1f); 
		// here is my method to draw  Octahedron
		...
		GL11.glRotatef(45, 0f, 1f, 0f);
		GL11.glRotatef(rotation, 1f, 1f, -1f); 
		// here is my method to draw Icosahedron
		...
		// here is my method to draw  Cylinder
